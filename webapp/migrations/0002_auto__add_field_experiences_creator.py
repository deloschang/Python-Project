...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiences.creator'
        db.add_column('webapp_experiences', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiences.creator'
        db.delete_column('webapp_experiences', 'creator_id')
