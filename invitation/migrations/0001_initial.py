...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitation_invitationkey', (
            ...
            ('from_user_album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webapp.Experiences'], null=True)),
            ('to_user_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
    ...
    models = {
        ...
        'invitation.invitationkey': {
            ...
            'from_user_album': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webapp.Experiences']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'to_user_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'})
        },
        'webapp.experiences': {
